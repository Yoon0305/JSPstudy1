	...
	<div class="container ">
		<div
			...
			<ul class="nav nav-pills">
				...
				<li class="nav-item"><a href="<c:url value="/books.jsp"/>"	class="nav-link">DVD 목록</a></li>
				<li class="nav-item"><a href="<c:url value="/addBook.jsp"/>" class="nav-link">DVD 등록</a></li>
				<li class="nav-item"><a	href="<c:url value="/editBook.jsp?edit=update"/>" class="nav-link">DVD 수정</a></li>
				<li class="nav-item"><a	href="<c:url value="/editBook.jsp?edit=delete"/>" class="nav-link">DVD 삭제</a></li>
